        ...
        <nav class="sidebar sidebar-bunker">
            <div class="sidebar-header">
                <a href="<?php echo base_url() ?>" class="logo"><img
                        src="<?php echo base_url(!empty($settings->logo) ? esc($settings->logo) : "public/assets/images/icons/logo.png"); ?>"
                        alt=""></a>
            ...
            <div class="profile-element d-flex align-items-center flex-shrink-0">
                <div class="avatar online">
                    <img src="<?php echo base_url(!empty(session('image'))?session('image'):'public/assets/images/icons/user.png') ?>" class="img-fluid rounded-circle" alt="">
                </div>
