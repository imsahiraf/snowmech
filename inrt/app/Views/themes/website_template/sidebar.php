...
?>
                                <li><a href="<?php echo base_url($request->uri->setSilent()->getSegment(1).'/'.esc($cat_slug->slug)."/$slug"); ?>"><?php echo esc($news_headline); ?></a></li>
<?php } ?>
                            </ul>
                        </div>
                        <!-- /.End of recent post -->
...
<?php } ?>
                        ...
                        <div class="widget">
                            ...
                            <ul class="widget_category categories">
                                ...
                                ?>
                                    <li><a href="<?php echo base_url("blog/$newscatslug") ?>"><span>#</span><?php echo esc($newscatname_list) ?></a></li>
                                <?php
                                    }
                                ?>
                            </ul>
                    ...
                    <?php if ($social_link) { ?>
                        <div class="widget">
                            ...
                            <?php foreach ($social_link as $key => $value) { ?>
                                <a href="<?php echo esc($value->link); ?>" class="<?php echo esc($value->icon); ?>"><i class="fab fa-<?php echo esc($value->icon); ?>"></i></a>
                            <?php } ?>    
                            </div>
