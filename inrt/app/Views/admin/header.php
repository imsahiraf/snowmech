        ...
        <nav class="navbar-custom-menu navbar navbar-expand-lg m-0">
            ...
            <div class="d-flex flex-grow-1">
                <ul class="navbar-nav flex-row align-items-center ml-auto">
                    <?php if($max_version > $current_version && $settings->update_notification == 1){ echo $max_version;die();?>

                            <?php  if(session('isAdmin') == 1){?> 
                    <li> <blink><a href="<?php echo base_url('backend/autoupdate/autoupdate')?>" class="text-black  btn-warning update-btn blink_text"> <?php echo $max_version.' Version Available'; ?></a></blink>
                    </li>
                             <?php }?>
                  <?php }?>
