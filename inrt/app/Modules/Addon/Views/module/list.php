                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart("backend/module/upload") ?>
                            <div class="row">
                                ...
                                <div class="col-sm-6 themeupload mt-2">
                                    <div class="pull-left overwrite">
                                        ...
                                        <button type="submit" class="btn btn-success m-2"><?php echo display('add_module') ?></button>
                                    </div>
                        ...
                        <?php echo form_close() ?>
                            ...
                            <div class="row">
                                ...
                                $def_mods = ['Auth','Addon','Cms','Coinpayment','Common','Exchange','Finance','Help_line','Gourl','Ico_settings','Package','Paypal','Phone','Settings','Stripe','System_user','User','Website'];
                                if (is_array($map))
