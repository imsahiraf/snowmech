...
$CUSTOMERMENU['notification'] = array(
            'order'         => 7,
            'parent'        => display('notification'),
            'status'        => 0,
            'link'          => 'notifications/notification-list',
            'icon'          => '<i class="hvr-buzz-out fab fa-rocketchat"></i>',
            'segment'       => 2,
            'segment_text'  => 'notification-list'
        );
$CUSTOMERMENU['sms'] = array(
            'order'         => 8,
            'parent'        => display('sms'),
            'status'        => 0,
            ...
            'segment'       => 2,
            'segment_text'  => 'message-list'
        );
$CUSTOMERMENU['Help_line'] = array(
            'order'         => 9,
            'parent'        => display('help_line'),
            'status'        => 0,
            'link'          => 'help-line/helpline',
            'icon'          => '<i class="hvr-buzz-out fab fa-rocketchat"></i>',
            'segment'       => 2,
            'segment_text'  => 'helpline'
        );