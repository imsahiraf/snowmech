                ...
                <div class="col-md-12 col-lg-12 p-0 inbox-mail">
                    <div class="inbox-avatar-wrap p-3 border-btm d-sm-flex">
                        ...
                        <div class="inbox-avatar-text ml-sm-3 mb-2 mb-sm-0">
                            ...
                            <div><strong>Subject: </strong><small><?php echo esc($notification->subject);?></small></div>
                        </div>
                        <div class="inbox-date">
                            <div><span class="badge badge-info"><?php echo esc($notification->subject);?></span></div>
                    ...
                    <div class="inbox-mail-details p-3">
                        ...
                        <p><span><?php echo esc($notification->details); ?></span></p>
                    </div>
                </div>
            </div>
        </div>
