      ...
      <div class="col-sm-12 col-md-12 col-lg-12 p-0 inbox-mail">
        ...
        <?php 
            foreach($messageList as $val){
	            ...
	            $datetime = new DateTime($val->datetime);
	            $date = $datetime->format('Y-M-D');
	            $time = $datetime->format('H:i:sa');
        ?>
        <?php $read_unread = $val->receiver_status == 0?"new-message":"";?>
        <div data-href="<?php echo base_url("customer/message/details/$val->id")?>" class="inbox_item d-flex align-items-center unread <?php echo $read_unread;?>">
            <a href="<?php echo base_url("customer/message/details/$val->id")?>">
            ...
            <div class="inbox-avatar-text">
              ...
              <div>
                <span> <?php echo esc($val->message); ?> </span>
              </div>
            </div>
            <div class="inbox-date d-none d-xl-block">
              <div class="date <?php echo $read_unread;?>">
                <?php echo esc($time);?>
              </div>
              <div>
                <small>
