      ...
      <table id="example" class="table display table-bordered table-striped table-hover">
        <thead>
          <tr>
            ...
            <th>
              <?php echo display('method') ?>
            </th>
            <th>
              <?php echo display('wallet_id') ?>
            </th>
            <th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <?php echo esc($coininfo->pair_with." ".$value->amount); ?>
            </td>
            <td>
              <?php echo esc($value->fees_amount); ?>
            </td>
            <td class="text-center">
              <?php if($value->status == 2){?>
              <i title="Pending Withdraw" class="fas fa-spinner fa-pulse text-danger">
              </i>
            ...
            <td class="text-center d-flex">
              <a href="<?php echo base_url()?>/backend/finance/confirm-withdraw?id=<?php echo $value->id;?>&user_id=<?php echo $value->user_id;?>&set_status=2" class="btn btn-success btn-sm">
                <?php echo display('confirm')?>
              </a>&nbsp;
              <a href="<?php echo base_url()?>/backend/finance/cancel-withdraw?id=<?php echo $value->id;?>&user_id=<?php echo $value->user_id;?>&set_status=3" class="btn btn-danger btn-sm">
                <?php echo display('cancel')?>
              </a>&nbsp;
              <a href="#<?php echo $value->user_id;?>" class="AjaxModal btn btn-info btn-sm" data-toggle="modal" data-target="#newModal"> 
                <i class="fa fa-info-circle info-position" data-toggle="tooltip" data-original-title="Information">
                </i>
              </a>
            </td>
          </tr>
...
<script src="<?php echo base_url('app/Modules/Finance/Assets/Admin/js/custom.js?v=2.2') ?>"></script>