            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8"> 
                        ...
                        <div class="form-group row">
                            <label for="template_en" class="col-sm-3 col-form-label font-weight-600"><?php echo display('template_english'); ?><i class="text-danger">*</i></label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="template_en" required><?php echo $template->template_en ?></textarea>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="template_fr" class="col-sm-3 col-form-label font-weight-600"><?php echo display('template_french');?><i class="text-danger">*</i></label>
                            <div class="col-sm-9">
