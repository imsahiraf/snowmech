        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="phone" type="number" class="form-control" id="phone" placeholder="<?php echo display('phone') ?>"  value="<?php echo esc($setting->phone) ?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <span class="mention-text">32x32px(jpg, jpeg, png)</span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <span class="mention-text">147x50px(jpg, jpeg, png)</span>
                    ...
                    <div class="payout_cronjob_setting">
                        <h2><?php echo display('payout_cronjob'); ?></h2>
                        <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary  pt-2 pb-2 copy1" type="button"><?php echo display('copy'); ?></button>
                                </span>
                        </div>
                        <p>
...
<script src="<?php echo base_url('app/Modules/Settings/Assets/Admin/js/custom.js')?>" type="text/javascript"></script> 