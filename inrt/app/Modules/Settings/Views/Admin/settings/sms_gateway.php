                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            <label for="gatewayname" class="col-sm-3 font-weight-600">Gateway <i class="text-danger">*</i></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-sm-3 font-weight-600"><?php echo display('title') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9">
                        ...
                        <span id="sms_field"> </span>
                         <div class="form-group row">
                            <label for="title" class="col-sm-3 font-weight-600"></label>
                            <div class="col-sm-9">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <div class="form-group row">
                            <label for="mobile_num" class="col-sm-3 font-weight-600"><?php echo display('mobile_no');?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="mobile_num" id="mobile_num" placeholder="e. 88xxxxxxxx">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="test_message" class="col-sm-3 font-weight-600"><?php echo display('message');?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9">
                                <textarea rows="5" class="form-control" name="test_message" id="test_message" placeholder="Test Message"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 font-weight-600">&nbsp;</label>
                            <div class="col-sm-9">
...
<script src="<?php echo base_url("app/Modules/Settings/Assets/Admin/js/custom.js?v=1.9") ?>" type="text/javascript"></script>