<div class="row">
     <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <?php 
                    echo form_open_multipart(base_url("backend/account/add-admin/$admin->id")) 
                ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="firstname" class="form-control <?php if(isset($errorsList['firstname'])){echo "common_error_border"; } ?>" type="text" placeholder="<?php echo display('firstname') ?>" id="firstname"  value="<?php echo esc(@$admin->firstname) ?>">
                            <span class="text-danger"><?php if(isset($errorsList['firstname'])){echo "<i class='fas fa-exclamation-circle text-warning' title='warning'></i> ".$errorsList['firstname']; } ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="lastname" class="form-control <?php if(isset($errorsList['firstname'])){echo "common_error_border"; } ?>" type="text" placeholder="<?php echo display('lastname') ?>" id="lastname" value="<?php echo esc(@$admin->lastname) ?>">
                            <span class="text-danger"><?php if(isset($errorsList['lastname'])){echo "<i class='fas fa-exclamation-circle text-warning' title='warning'></i> ".$errorsList['lastname']; } ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="email" class="form-control <?php if(isset($errorsList['firstname'])){echo "common_error_border"; } ?>" type="text" placeholder="<?php echo display('email') ?>" id="email" value="<?php echo esc(@$admin->email) ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="password" class="form-control <?php if(isset($errorsList['firstname'])){echo "common_error_border"; } ?>" type="password" placeholder="<?php echo display('password') ?>" id="password">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="text-danger">115x90 px(jpg, jpeg, png)</span><br>
                            <span class="text-danger"><?php if(isset($errorsList['image'])){echo "<i class='fas fa-exclamation-circle text-warning' title='warning'></i> ".$errorsList['image']; } ?></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <a href="<?php echo base_url('backend/account/admin_list'); ?>" class="btn btn-primary  w-md m-b-5"><?php echo display("cancel") ?></a>
