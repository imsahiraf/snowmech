            ...
            <div class="card-body">
                ...
                <?php echo form_hidden('id', $social_link->id) ?> 
                    <div class="form-group row">
                        <label for="name" class="col-sm-4 col-form-label font-weight-600"><?php echo display("name") ?><i class="text-danger">*</i></label>
                        <div class="col-sm-8">
                            <input name="name" value="<?php echo esc($social_link->name) ?>" class="form-control" type="text" id="name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="link" class="col-sm-4 col-form-label font-weight-600"><?php echo display("link") ?><i class="text-danger">*</i></label>
                        <div class="col-sm-8">
                            <input name="link" value="<?php echo htmlspecialchars_decode($social_link->link) ?>" class="form-control" type="text" id="link">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="icon" class="col-sm-4 col-form-label font-weight-600"><?php echo display("icon") ?><i class="text-danger">*</i></label>
                        <div class="col-sm-8">
                            <input name="icon" value="<?php echo htmlspecialchars_decode($social_link->icon) ?>" class="form-control" type="text" id="icon">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="status" class="col-sm-4 col-form-label font-weight-600"><?php echo display('status') ?><i class="text-danger">*</i></label>
