                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="border_preview">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="cat_name_en" value="<?php echo esc($category->cat_name_en) ?>" class="form-control <?php if(isset($errorsList['cat_name_en'])){echo "common_error_border"; } ?>" placeholder="<?php echo display('cat_name_en') ?>" type="text" id="cat_name_en">
                                <span class="text-danger"><?php if(isset($errorsList['cat_name_en'])){echo "<i class='fas fa-exclamation-circle text-warning' title='warning'></i> ".$errorsList['cat_name_en']; } ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="cat_name_fr" class="col-sm-4 font-weight-600"><?php echo display('cat_name')." ".esc($web_language->name) ?></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-4 font-weight-600"><?php echo display('image') ?></label>
                            <div class="col-sm-8">
                                ...
                                <span class="text-danger">400 x 400px (png,jpg,gif,ico)</span><br>
...
<!-- summernote js -->
<script src="<?php echo base_url('public/assets/plugins/summernote/summernote.min.js'); ?>" type="text/javascript"></script>
