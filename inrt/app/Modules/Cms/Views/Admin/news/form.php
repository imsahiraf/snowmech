                ...
                <?php echo form_open_multipart(base_url("backend/cms/add-news/$article->article_id")) ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="text-danger">290x185 px(jpg, jpeg, png)</span><br>
                    ...
                    <div class="form-group row">
                        <label for="article1_en" class="col-sm-2 font-weight-600"><?php echo display('article_en') ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-10">
