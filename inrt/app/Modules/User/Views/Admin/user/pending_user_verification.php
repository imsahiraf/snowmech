        	...
        	<div class="col-sm-7 col-md-7">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 card-body">
                	...
                	<div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        	<h5>
                            <?php if ($user->verified == 0) { echo "<span class='text-primery'>Not Submited</span>"; } ?>
                            <?php if ($user->verified == 1) { echo "<span class='text-success'>Verified</span>"; } ?>
                            <?php if ($user->verified == 2) { echo "<span class='text-danger'>Canceled</span>"; } ?>
                            <?php if ($user->verified == 3) { echo "<span class='text-danger'>Processing</span>"; } ?>
                            </h5>
                        </div>
                    </div>
