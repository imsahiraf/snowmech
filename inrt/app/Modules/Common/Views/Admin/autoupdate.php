                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="alert alert-success text-center updatebox"><?php echo display('latest_version');?> <br>V-<?php echo esc($latest_version) ?></div>
                                </div> 
                                <div class="col-sm-3">
                                    <div class="alert alert-danger text-center updatebox"><?php echo display('current_version');?> <br>V-<?php echo esc($current_version) ?></div>
                                </div>
                                <div class="col-sm-3">&nbsp;</div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="mt-2">
                                ...
                                <?php } ?>
                                <a class="btn btn-warning mt-2 text-white" href="<?php echo base_url('backend/autoupdate/backup-database'); ?>"><i class="fas fa-database"></i> <?php echo "Backup Database";?></a>
                            </div>
                        </div>
                        <div class="form-group col-sm-3">&nbsp;</div>
                    </div> 
                ...
                <?php } else {  ?>
                    <div class="row">
                        ...
                        <div class="col-lg-4 text-center">
                             <blink class="text-success text-center updatecss"><?php if(empty($exception_txt)) echo htmlspecialchars_decode($message_txt) ?></blink><br>
...
<script src="<?php echo base_url('app/Modules/Common/Assets/Admin/js/custom.js?v=2.8') ?>"></script>